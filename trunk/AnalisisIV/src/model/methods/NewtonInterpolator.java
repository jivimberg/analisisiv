...
public class NewtonInterpolator {
    ...
    public final MyFunction interpolate(final List<Point2D.Double> points) {
    ...
    public static void main(String[] args) {
        ...
        jMathLib.methods.interpolators.NewtonInterpolator li = new jMathLib.methods.interpolators.NewtonInterpolator();
