...
public class Romberg {
     ...
     *
     * @param function      the  numeric function
    ...
    public void calculate(Function function, double from, double to, int maxIterations) {
        double[][] r = new double[3][20];
        double h = to - from;
        r[1][1] = (h / 2) * (function.resolve(from) + function.resolve(to));
        System.out.println(r[1][1]);
        for (int i = 2; i <= maxIterations; i++) {
            r[2][1] = 0.5 * (r[1][1] + sum(function, from, i, h));
