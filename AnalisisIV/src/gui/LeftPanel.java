...
public class LeftPanel extends JPanel {
    ...
    public LeftPanel(Action showNumberOffsetAction, Action restartAxisAction, Action goToAction) {
	...
	private JPanel createFirstButtonPanel() {
        ...
        restartAxisButton.setToolTipText("Centra los ejes en el medio de la pantalla");
        JPanel panel = new JPanel();
        panel.add(Box.createGlue());
